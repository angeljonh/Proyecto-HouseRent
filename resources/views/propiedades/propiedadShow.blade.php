    ...
    <div class="row justify-content-center">
        <div class="col-md-13">
            <div class="card">
                ...
                <div class="card-body">
                  <a href="{{ route('propiedad.index') }}" class="btn btn-default btn-sm">Mis propiedades</a>
                    <table class="table">
                    <thead>
                        <tr><th>ID</th> <th>Nombre</th><th>Domicilio</th> <th>Numero</th> <th>Zona</th><th>Codigo postal</th> <th>Precio</th><th>Area</th> <th>Camas</th><th>Cuartos</th> <th>Baños</th><th>Telefono</th><th>Accion</th></tr>
                      </thead>
                      <tbody>
                          <tr>
                            <td>{{ $propiedad->id }}</td>
                            ...
                            <td>{{ $propiedad->zona->zona }}</td>
                            <td>{{ $propiedad->cp }}</td>
                            <td>{{ $propiedad->precio }}</td>
                            <td>{{ $propiedad->area }}</td>
                            <td>{{ $propiedad->camas }}</td>
                            <td>{{ $propiedad->cuartos }}</td>
                            <td>{{ $propiedad->baños }}</td>
                            <td>{{ $propiedad->telefono }}</td>
                            <td>
                            <a href="{{ route('propiedad.edit', $propiedad->id) }}" class="btn btn-sm btn-warning">Editar</a>
                ...
                @include('archivos.archivoForm', ['modelo_id' => $propiedad->id, 'modelo_type' => 'App\Propiedad'])
                @include('archivos.archivoIndex', ['archivos' => $propiedad->archivos])
            </div>
        </div>
    </div>
</div>
