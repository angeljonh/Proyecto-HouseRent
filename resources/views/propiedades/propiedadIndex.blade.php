        ...
        <div class="col-md-16">
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table">
                      <thead>
                        <tr><th>ID</th><th>Nombre</th><th>Descripción</th> <th>Domicilio</th> <th>Numero</th> <th>Zona</th><th>Codigo postal</th> <th>Precio</th><th>Area</th> <th>Camas</th><th>Cuartos</th> <th>Baños</th> <th>Telefono</th><th>Accion</th></tr>
                      </thead>
                      <tbody>
                        @foreach($propiedades as $propiedad)
                          <tr>
                            ...
                            <td>
                                <a href="{{ route('propiedad.show', $propiedad->id) }}" class="btn btn-sm btn-info">Ver Detalle</a>
                            </td>
                          </tr>
                        @endforeach
                      </tbody>
